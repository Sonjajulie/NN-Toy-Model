...
#
    ...
    model.add(Dense(nr_neurons, input_dim=4,kernel_initializer=initializers.TruncatedNormal(mean=0.0, stddev=0.02, seed=None), bias_initializer=initializers.TruncatedNormal(mean=0.0, stddev=0.02, seed=None), activation='sigmoid',
kernel_regularizer=regularizers.l2(0.0001)#sigmoid
))
    model.add(Dense(nr_neurons, kernel_initializer=initializers.TruncatedNormal(mean=0.0, stddev=0.02, seed=None), bias_initializer=initializers.TruncatedNormal(mean=0.0, stddev=0.02, seed=None), activation='sigmoid',
...
#        loss='categorical_crossentropy'
        ...
        ,optimizer=keras.optimizers.Adam(lr=0.2,decay=0.001)#lr=0.2,decay=0.001
